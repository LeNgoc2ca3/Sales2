...
//        Các AuthenticationProvider có trách nhiệm xử lý yêu cầu và thực hiện xác thực cụ thể. Nó cung cấp cơ chế lấy
//        thông tin của người dùng mà chúng ta có thể thực hiện xác thực
        return super.authenticationManager();
    }

    @Override
    public void configure(WebSecurity web) throws Exception {//cho phép rest api truy xuất từ domain khác
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/order/**").authenticated().and().authorizeRequests()
//                .antMatchers("/assets/admin/**").hasRole("STAF")
